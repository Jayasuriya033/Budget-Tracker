...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({ message: response.data.message || "Login successful", type: "success" })
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl rounded-lg p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-300">Access your budget dashboard</p>
            </div>
